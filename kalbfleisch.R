...
theta_arr <- seq(epsilon, 6 * thetaguess, length.out = 250)
RM_arr <- c()
CR_arr <- c()
...
plot(theta_arr[-1], RM_arr[-1], type = "l", lty = 2, ylim=c(0,1))
...
# }
# 
# psi_arr <- seq(epsilon, 6 * psiguess, length.out = 250)
# RM_arr <- c()
# CR_arr <- c()
# for(psi in psi_arr){
#   print("new")
...
# }
# plot(psi_arr[-1], RM_arr[-1], type = "l", lty = 2, ylim=c(0,1))
