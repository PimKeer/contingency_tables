...
png("benchmark_both_N_lp1.png", width = 466, height = 351)
...
for(N in N_arr){
  ...
  png(paste(N,"_single_N_lp1.png", sep = ""), width = 466, height = 351)
  plot_power_matrix(power_mat, FALSE)
  dev.off()
  
  png(paste(N,"_single_N_diff_lp1.png", sep = ""), width = 466, height = 351)
